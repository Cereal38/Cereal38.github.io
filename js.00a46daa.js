...
; // END - AUTO SCROLL
// SWITCH IMAGES SECTION 3 - TEST

document.getElementById("section-3__box-image").innerHTML = "<p>Hello</p>";
var image_nb = 0;

document.getElementById("section-3__box-scroll-right").onclick = function () {
  if (image_nb === 0) {
    document.getElementById("section-3__box-image").innerHTML = "<p>To</p>";
    image_nb = 1;
  } else if (image_nb === 1) {
    document.getElementById("section-3__box-image").innerHTML = "<p>You</p>";
    image_nb = 2;
  } else {
    document.getElementById("section-3__box-image").innerHTML = "<p>Hello</p>";
    image_nb = 0;
